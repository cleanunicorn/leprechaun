...
check_moving_average = function() {
  ...
  return kraken.api('Trades', {
    ...
    var data_set, i, least_difference, ma_long, ma_long_size, ma_long_value, ma_short, ma_short_size, ma_short_value, pondered_value, quantity, value, _i, _j, _ref, _ref1, _ref2, _ref3;
    if (error) {
      return console.log(error);
    } else {
